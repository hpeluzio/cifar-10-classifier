...
# plt.imshow(X_training[0]) # With color
...
training_class = np_utils.to_categorical(y_training, 10) # Dummy variables
test_class = np_utils.to_categorical(y_test, 10) # Dummy variables
